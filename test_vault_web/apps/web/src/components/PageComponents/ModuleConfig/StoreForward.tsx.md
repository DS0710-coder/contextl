...
- **Path:** `apps/web/src/components/PageComponents/ModuleConfig/StoreForward.tsx`
- **Extension:** `.tsx`
- **Size:** 3506 bytes
...
- [[apps/web/src/validation/moduleConfig/storeForward.ts.md|apps/web/src/validation/moduleConfig/storeForward.ts]]
