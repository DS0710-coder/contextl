...
- **Path:** `apps/web/src/components/PageComponents/ModuleConfig/RemoteHardware.tsx`
- **Extension:** `.tsx`
- **Size:** 2196 bytes
...
- [[apps/web/src/validation/moduleConfig/remoteHardware.ts.md|apps/web/src/validation/moduleConfig/remoteHardware.ts]]
