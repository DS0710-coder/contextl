...
- **Path:** `apps/web/src/components/PageComponents/ModuleConfig/AmbientLighting.tsx`
- **Extension:** `.tsx`
- **Size:** 3245 bytes
...
- [[apps/web/src/validation/moduleConfig/ambientLighting.ts.md|apps/web/src/validation/moduleConfig/ambientLighting.ts]]
