...
- **Path:** `apps/web/src/components/PageComponents/ModuleConfig/ExternalNotification.tsx`
- **Extension:** `.tsx`
- **Size:** 6793 bytes
...
- [[apps/web/src/validation/moduleConfig/externalNotification.ts.md|apps/web/src/validation/moduleConfig/externalNotification.ts]]
