...
- **Path:** `apps/web/src/components/PageComponents/ModuleConfig/NeighborInfo.tsx`
- **Extension:** `.tsx`
- **Size:** 2852 bytes
...
- [[apps/web/src/validation/moduleConfig/neighborInfo.ts.md|apps/web/src/validation/moduleConfig/neighborInfo.ts]]
