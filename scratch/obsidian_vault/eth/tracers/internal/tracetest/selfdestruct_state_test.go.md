# selfdestruct_state_test.go

## Architecture Metrics
- **Path:** `eth/tracers/internal/tracetest/selfdestruct_state_test.go`
- **Extension:** `.go`
- **Size:** 21617 bytes
...
## Structural Outline
- `accountState`
- `selfdestructStateTracer`
- `newSelfdestructStateTracer`
- `OnTxStart`
- `OnTxEnd`
- `getOrCreateAccount`
- `OnBalanceChange`
